...
```
## Participants
Our first aim was to assess whether our balloon finding task induces variation in a child and adult sample. The pre-registrations can be found here: https://osf.io/snju6 (child sample) and here: https://osf.io/r3bhn (adult sample). Participants were equally distributed across the two study versions. 
...
```
## Participants
Our second aim was to assess whether the variation that we captured with our balloon finding task is reliable. The pre-registrations can be found here: https://osf.io/xqm73 (child sample) and here: https://osf.io/nu62m (adult sample).
