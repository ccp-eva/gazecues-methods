...
Only the `predictor age of childcare entry` improved the model fit compared to the null model (see Figure Figure \@ref(fig:fig4)A; for model comparisons, see Supplements). Figure \@ref(fig:fig4)B shows that all other predictor scores were positively linked to gaze understanding. Albeit the effects were weak, they are consistent with the literature.
