---
title             : "Measuring individual differences in the understanding of gaze cues across the lifespan [Julia: ich würde mehr info in den titel packen - sowas wie reliable, open-source, web-based task to measure individual differences in gaze cue understanding in children (vll sogar age range) and adults. Ich denke bei do nem methods paper ist es wichtig das man weiß was phase ist basierend auf dem Titel. Vll willst DU auch ein Acronym? :)]"
...
abstract: |
  ...
  All materials and code are freely accessible to interested researchers. A version of the task is accessible online: https://ccp-odc.eva.mpg.de/gafo-demo/. 
...
We designed the task as an interactive browser-based web app [Julia: hier noch folgendes paper zitieren: http://dx.doi.org/https://doi.org/10.1080/15248372.2015.1061528; falls du den ansatz noch mehr "legitimieren" willst, kannst du auch noch eins oder zwei meiner tablet paper zitieren, zB: https://onlinelibrary.wiley.com/doi/10.1111/desc.13049  oder https://www.nature.com/articles/s41562-021-01145-1. Zeigt einfach dass das schon "erfolgreich" eingesetzt wird.].
...
Response rate to invitations after the reminder was \~50%.
...
[Julia: Kannst du in Figure 2 panel F noch chance linie mit rein machen?]
...
Data collection and analysis were pre-registered (<https://osf.io/xqm73> for the child sample and <https://osf.io/nu62m> for the adult sample).
Participants were equally distributed across the two study versions.
The study was approved by an internal ethics committee at the Max Planck Institute for Evolutionary Anthropology.
...
The web app (<https://ccp-odc.eva.mpg.de/gafo-demo/>) and its source code (<https://github.com/ccp-eva/gafo-demo>) are freely accessible.
...
Therefore, when a sufficient amount of trials is presented, the box version of the task can also yield reliable individual estimates (cf. @hughes2000good; improved reliability through aggregation).
...
By inducing more between-person variance, reliability estimates could further increase [Julia: hier vll nochmal sagen, dass die momentanen properties abers chon gut sind].
...
Therefore, we argue that future research should aim at implementing statistical analyses that mirror the experimental design in its complexity [Julia: Hier noch das zitieren: https://psyarxiv.com/xr7y3/].
...
[Julia: Hier oder weiter oben eingebaut könntest du nochmal die wishlist aufgreifen und sagen in wie fern der task die Forderungen darin abdeckt - muss nicht sein, aber wäre denke ich nett weil das so ein coole Rechfertigung ist.]
...
For example, it has been postulated that social-cognitive abilities are predicted by family-level variables and children's language abilities [Julia: hier noch eine ziation jeweils, also einmal family einmal language].
[Julia: Hab das alles raus genommen - macht meiner meinung nach wenig sinn das an zu teasern und dann zu sagen das kommt in nem anderen paper. ich als reviewer oder editor würde sagen: pack das hie rein. Daher eher sagen: future research should probe these realtions (family level und language)].

Our future goal is to utilize the presented testing infrastructure for further studies on social-cognitive abilities.
As has been pointed out, social cognition encompasses a whole range of abilities which could be best assessed by task batteries [@hughes2011individual; @schaafsma2015deconstructing].
...
These resources allow interested researchers to use, extend and adapt the task. [Julia: Du könntest überlegen hier oder weiter oben noch einen screenshot von der demo version als figure zu nehmen. Das macht die usability nochmal konkreter.]
