...
Researchers are interested in questions concerning individual differences in the social cognition domain [@hughes2015individual]. Previous studies focused, for example, on the association of stereotypes and theory of mind [@rizzo2018theory], mental state talk and false belief understanding [@hughes2011individual], attachment quality and gaze following [@astor2020social], language and gaze following [@okumura2017individual], emotion, language, family interaction and belief understanding [@dunn1991young; @cutting1999theory; @bulgarelli2016social], and the interplay of physical and social cognition [@herrmann2010structure]. Correlational approaches have also been used to argue for and test assumptions of cognitive development theories [@mundy2007individual; @kidd2018individual; @underwood1975individual]. 
...
Methods, that have currently been used, are...
One of the most commonly applied measures in social cognition research is the Sally-Anne task. [TODO: fill in FB studies]
The outcome measures false belief understanding in a dichotomous way: children pass the task if they answer that the protagonist would ...
...
By acting as a 'front end ability' [@brooks2005development, p. 535], following an agent's gaze provides insights into their intentions, thoughts, and feelings. 
In our definition, gaze cue understanding goes one step further by including the *acting* on the gaze-cued location. 
