...
## Study versions
We designed two study versions which can be chosen according to the researchers' need: there is a continuous *hedge* version and a discrete *box* version. The versions use the same first training trial and then differ in the two consecutive training trials and the test trials. 
