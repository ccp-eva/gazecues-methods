...
hedge_variation_plot_GLMM <- readRDS(file = "../saves/gafo-hedge-variation-plot-GLMM.rds")
box_variation_plot_GLMM <- readRDS(file = "../saves/gafo-box-variation-plot-GLMM.rds")
