...
\caption{\textbf{Infrastructure for online testing}. (i) With our new infrastructure, subjects aged 3 -- 99+ can participate. Data collection is efficient and automatized and can take place anywhere: at home, in kindergartens or research institutes. (ii) Our task is presented as a website that works across devices. (iii) The scripts for the website and recorded data are stored on secure local servers.}\label{fig:fig2}
\end{figure}

\hypertarget{data-processing-1}{%
\subsection{Data processing}\label{data-processing-1}}

We used R {[}Version 4.1.2; R Core Team (2021){]} and the R-packages \emph{brms} {[}Version 2.15.0; Bürkner (2017); Bürkner (2018){]}, \emph{dplyr} {[}Version 1.0.7; Wickham, François, Henry, and Müller (2021){]}, \emph{forcats} {[}Version 0.5.1; Wickham (2021a){]}, \emph{ggplot2} {[}Version 3.3.5; Wickham (2016){]}, \emph{ggpubr} {[}Version 0.4.0; Kassambara (2020){]}, \emph{ggthemes} {[}Version 4.2.4; Arnold (2021){]}, \emph{papaja} {[}Version 0.1.0.9997; Aust and Barth (2020){]}, \emph{purrr} {[}Version 0.3.4; Henry and Wickham (2020){]}, \emph{Rcpp} {[}Version 1.0.6; Eddelbuettel and François (2011); Eddelbuettel and Balamuta (2018){]}, \emph{readr} {[}Version 1.4.0; Wickham and Hester (2020){]}, \emph{stringr} {[}Version 1.4.0; Wickham (2019){]}, \emph{tibble} {[}Version 3.1.6; Müller and Wickham (2021){]}, \emph{tidyboot} {[}Version 0.1.1; Braginsky and Yurovsky (2018){]}, \emph{tidyr} {[}Version 1.1.4; Wickham (2021b){]}, \emph{tidyverse} {[}Version 1.3.1; Wickham et al. (2019){]}, \emph{viridis} {[}Version 0.6.1; Garnier et al. (2021a); Garnier et al. (2021b){]}, and \emph{viridisLite} {[}Version 0.4.0; Garnier et al. (2021b){]} for all our analyses. Regression models were fitted as Bayesian generalized linear mixed models (GLMMs) with default priors for all analyses.
...
\begin{figure}
\includegraphics[width=0.49\linewidth]{../figures/gafo_hedge_variation} \includegraphics[width=0.49\linewidth]{../figures/gafo_box_variation} \caption{\textbf{Interindividual variation}.
...
Based on the results of Study 1, we wanted to further investigate the reliability of our measure. We analyzed the test-retest reliability by testing the same individual twice.
