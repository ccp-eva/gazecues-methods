...
\hypersetup{
  pdftitle={TANGO: A reliable, open-source, web-based task to assess individual differences in gaze understanding in 3 to 5-year-old children and adults},
...
All materials and code are freely accessible to interested researchers. A version of the task is accessible online: \url{https://ccp-odc.eva.mpg.de/tango-demo/}.''
}
