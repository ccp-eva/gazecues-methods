...
extvaliPostSamples <- bind_rows(
  ...
  mutate(
    model = factor(model, levels = extvaliModelorder, labels = c("sibling variety score (Cassidy et al., 2005)", "number of children in household aged 1-12", "number of children in household aged 0-18", "null model", "number of household members", "average hours spent in childcare per day", "age of childcare entry", "sibling variety score (Peterson, 2000)", "peer exposure index"))  
  )

write.csv(extvaliPostSamples, "../saves/extvali-posteriorsamples.csv", quote = F, row.names = F)
saveRDS(extvaliPostSamples, "../saves/extvali-posteriorsamples.rds")
...
ggsave("../figures/extvali-posteriorsample.png", width = 6, height = 3)
```
