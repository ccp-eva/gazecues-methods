...
saveRDS(hedge_retest_correlationcoefficients, file = "../saves/gafo-hedge-retest-correlationcoefficients.rds")
```
...
saveRDS(hedge_retest_kids, file = "../saves/gafo-hedge-retest-kids.rds")
...
saveRDS(hedge_retest_adults, file = "../saves/gafo-hedge-retest-adults.rds")
...
saveRDS(box_retest_kids, file = "../saves/gafo-box-retest-kids.rds")
...
saveRDS(box_retest_adults, file = "../saves/gafo-box-retest-adults.rds")
# ggsave("../figures/gafo_hedge_retest_adults.png", width = 6, height = 4)
```
...
gafo_arrangedplot
saveRDS(gafo_arrangedplot, file = "../saves/gafo-arrangedplot.rds")
# ggsave("../figures/gafo_arrangedplot.png", width = 6.5, height = 5, scale = 1.6, bg = "white")
```
