...
saveRDS(hedge_variation_plot_GLMM, file = "../saves/gafo-hedge-variation-plot-GLMM.rds")
...
saveRDS(box_variation_plot_GLMM, file = "../saves/gafo-box-variation-plot-GLMM.rds")
...
saveRDS(hedge_intCon_kids, file = "../saves/gafo-hedge-intCon-kids.rds")
...
saveRDS(hedge_intCon_adults, file = "../saves/gafo-hedge-intCon-adults.rds")
...
saveRDS(box_intCon_kids, file = "../saves/gafo-box-intCon-kids.rds")
...
saveRDS(box_intCon_adults, file = "../saves/gafo-box-intCon-adults.rds")
...
splithalf_plot
saveRDS(splithalf_plot, file = "../saves/gafo-splithalf-plot.rds")
...
saveRDS(splithalf_data, file = "../saves/gafo-splithalf-table.rds")
```
