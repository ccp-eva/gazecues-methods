...
saveRDS(hedge_variation_plot_GLMM, file = "../saves/tango_hedge_variation_plot_GLMM.rds")
...
saveRDS(box_variation_plot_GLMM, file = "../saves/tango_box_variation_plot_GLMM.rds")
...
saveRDS(hedge_intCon_kids, file = "../saves/tango_hedge_intCon_kids.rds")
...
saveRDS(hedge_intCon_adults, file = "../saves/tango_hedge_intCon_adults.rds")
...
saveRDS(box_intCon_kids, file = "../saves/tango_box_intCon_kids.rds")
...
saveRDS(box_intCon_adults, file = "../saves/tango_box_intCon_adults.rds")
...
splithalf_plot
saveRDS(splithalf_plot, file = "../saves/tango_splithalf_plot.rds")

ggsave("../figures/tango_splithalf.png", width = 8, height = 2.5, scale = 1.2)
ggsave("../figures/tango_splithalf.pdf", width = 8, height = 2.5, scale = 1.2)
```
...
write.csv(splithalf_data, "../saves/tango_splithalf_table.csv", quote = F, row.names = F)
saveRDS(splithalf_data, file = "../saves/tango_splithalf_table.rds")
...
saveRDS(hedge_retest_correlationcoefficients, file = "../saves/tango_hedge_retest_correlationcoefficients.rds")
write.csv(hedge_retest_correlationcoefficients, "../saves/tango_hedge_retest_correlationcoefficients.csv", quote = F, row.names = F)
```
...
saveRDS(hedge_retest_kids, file = "../saves/tango_hedge_retest_kids.rds")
...
saveRDS(hedge_retest_adults, file = "../saves/tango_hedge_retest_adults.rds")
...
saveRDS(box_retest_kids, file = "../saves/tango_box_retest_kids.rds")
...
saveRDS(box_retest_adults, file = "../saves/tango_box_retest_adults.rds")
# ggsave("../figures/tango_hedge_retest_adults.png", width = 6, height = 4)
```
...
tango_arrangedplot
saveRDS(tango_arrangedplot, file = "../saves/tango_arrangedplot.rds")
ggsave("../figures/tango_arrangedplot.png", width = 6.5, height = 5, scale = 1.6, bg = "white")
ggsave("../figures/tango_arrangedplot.pdf", width = 6.5, height = 5, scale = 1.6, bg = "white")
```

```{r supplements_reli_byagegroup}
ggarrange(
  hedge_intCon_kids + facet_grid(~ ageInYears), 
  hedge_retest_kids + facet_grid(~ ageInYears),
  box_intCon_kids + facet_grid(~ ageInYears) + scale_x_continuous(limits = c(0, 1), breaks = seq(0, 1, 0.5)), 
  box_retest_kids + facet_grid(~ ageInYears) + scale_x_continuous(limits = c(0, 1), breaks = seq(0, 1, 0.5)), 
  nrow = 2, 
  ncol = 2, 
  labels = c("A", "B", "C", "D")
)

ggsave("../figures/tango_supplements_reli_byagegroup.png", width = 8, height = 6)
ggsave("../figures/tango_supplements_reli_byagegroup.pdf", width = 8, height = 6)
```
