...
\urlstyle{same}
\hypersetup{
  pdftitle={Supplemental Material for the manuscript `TANGO: A reliable, open-source, browser-based task to assess individual differences in gaze understanding in 3 to 5-year-old children and adults'},
  pdfauthor={Julia Prein1, Manuel Bohn1,2, Steven Kalinke1, \& Daniel B. M. Haun1},
  pdflang={en-EN},
  hidelinks,
...
\midrule
By trial - Null model & 256.42 & 15.10 & 0.31 & 0.00 & 0.00\\
By trial - \# Verification choice & 256.57 & 15.46 & 0.29 & -0.07 & 1.08\\
By trial - Parental interference index & 258.08 & 15.38 & 0.14 & -0.83 & 0.76\\
By trial - \# Repeated testquestion & 258.83 & 15.25 & 0.09 & -1.20 & 0.61\\
By trial - \# Hints eyes & 258.88 & 15.30 & 0.09 & -1.23 & 0.50\\
\addlinespace
By trial - \# Words uttered by caregiver & 259.15 & 15.39 & 0.08 & -1.37 & 0.36\\
By subject - \# Repeated testquestion & 83.45 & 10.20 & 0.82 & 0.00 & 0.00\\
By subject - Parental interference index & 88.17 & 12.15 & 0.08 & -2.36 & 3.55\\
By subject - Null model & 89.36 & 11.28 & 0.04 & -2.96 & 3.59\\
By subject - \# Verification choice & 89.94 & 12.01 & 0.03 & -3.25 & 4.44\\
\addlinespace
By subject - \# Words uttered by caregiver & 90.50 & 10.62 & 0.02 & -3.52 & 4.19\\
By subject - \# Hints eyes & 93.02 & 11.84 & 0.01 & -4.78 & 3.71\\
\bottomrule
\end{tabular}}
\end{table}
...
Predictor & WAIC & SE\_WAIC & Weight & ELPD\_DIFF & SE\_ELPD\_DIFF\\
\midrule
Age of childcare entry & 571.54 & 28.09 & 0.72 & 0.00 & 0.00\\
Null model & 575.80 & 30.43 & 0.09 & -2.13 & 4.51\\
\# Children in household aged 0-18 & 577.29 & 29.61 & 0.04 & -2.88 & 4.70\\
Peer exposure index & 577.90 & 30.20 & 0.03 & -3.18 & 4.65\\
\# Children in household aged 1-12 & 578.02 & 29.93 & 0.03 & -3.24 & 4.69\\
\addlinespace
Sibling variety score (Cassidy et al., 2005) & 578.15 & 29.85 & 0.03 & -3.31 & 4.66\\
Sibling variety score (Peterson, 2000) & 578.21 & 29.84 & 0.03 & -3.34 & 4.64\\
\# Household members & 578.30 & 30.32 & 0.02 & -3.38 & 4.48\\
Average hours spent in childcare per day & 579.04 & 30.66 & 0.02 & -3.75 & 4.56\\
\bottomrule
\end{tabular}}
\end{table}
...
Predictor & WAIC & SE\_WAIC & Weight & ELPD\_DIFF & SE\_ELPD\_DIFF\\
\midrule
Age (scaled), TANGO score (scaled) & 570.16 & 26.38 & 0.98 & 0.00 & 0.00\\
Age (scaled) & 577.66 & 27.16 & 0.02 & -3.75 & 4.16\\
Null model & 635.72 & 28.70 & 0.00 & -32.78 & 10.62\\
\bottomrule
\end{tabular}}
\end{table}
